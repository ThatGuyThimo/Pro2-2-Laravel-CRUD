    ...
    <section class="flex flex-col items-center m-2">
        <div class="bg-gray-600 border-2 p-2 border-black rounded">
            <form class="flex flex-col" method="post" action="/updateprofile">
                ...
                <input name="email" class="rounded border-black p-1" type="Email" placeholder="Email" value="{{$email}}">
                <p class="text-white">Password</p>
                <input name="password" class="rounded border-black p-1" type="Password" placeholder="Password">
                <div class="flex flex-col items-center mt-2">
                    <div class="" >
                        <button type="submit" name="register" value="update" class="transition-all duration-300 bg-blue-600 rounded p-2 hover:bg-blue-700">update profile</button>
                    </div>
                </div>
                @csrf
            </form>
